...
public class Assignment3 {
    ...
    public double simulateSolution(int k, int K) {
    	...
    	this.seed1 = this.seed;
        MRG32k3a serviceRNG = getRNG();
        this.seed2 = this.seed;
 ...
 // simulates solution (k, K) and returns the average costs with a given seed
    public double simulateSolution(int k, int K, long[] reuseseed1, long[] reuseseed2) {

        // init random sources
    	MRG32k3a arrivalRNG = getRNG(reuseseed1);
        MRG32k3a serviceRNG = getRNG(reuseseed2);
